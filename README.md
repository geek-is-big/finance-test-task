...
Web application connects to locally running service, receives tickers, and displays them in real-time. In addition, tickers show positive and negative price change by color. It is possible to display more than 6 (default quantity) tickers if needed.
